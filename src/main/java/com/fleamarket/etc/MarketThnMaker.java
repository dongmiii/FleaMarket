...
public class MarketThnMaker implements ThumbnailMaker {
	...
	public void makeThumbnail(File uploadPath, String uploadFileName, MultipartFile multipartFile) {
		...
		this.uploadFileArr = new File[] {
				...
				new File(uploadPath, "marketMain_"+uploadFileName),
				new File(uploadPath, "marketDetail_"+uploadFileName)	
		};
		
		//인덱스 순서 정해져 있음
		this.sizeList = new HashMap<>();
		sizeList.put(0,new ThnSize<Integer>(100,100)); //s_
		sizeList.put(1,new ThnSize<Integer>(550,400)); //marketMain_
		sizeList.put(2,new ThnSize<Integer>(750,350)); //marketDetail_
